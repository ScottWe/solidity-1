...
uint8_t rt_nd_byte(const char* _msg){
	...
	on_entry("uint8", _msg);
	uint8_t retval = 0;
	retval = (uint8_t)(RandData[CounterOfRandData]);
	CounterOfRandData++;
	whether_RunOut();
	return retval;
}
...
sol_raw_int8_t nd_int8_t(const char* _msg){
	...
	for (int i = 1 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_int8_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
...
sol_raw_uint8_t nd_uint8_t(const char* _msg){
	...
	for (int i = 1 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_uint8_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
...
sol_raw_int16_t nd_int16_t(const char* _msg){
	...
	for (int i = 2 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_int16_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
...
sol_raw_uint16_t nd_uint16_t(const char* _msg){
	...
	for (int i = 2 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_uint16_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
...
sol_raw_int24_t nd_int24_t(const char* _msg){
	...
	for (int i = 3 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_int24_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
...
sol_raw_uint24_t nd_uint24_t(const char* _msg){
	...
	for (int i = 3 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_uint24_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
...
sol_raw_int32_t nd_int32_t(const char* _msg){
	...
	for (int i = 4 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_int32_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
...
sol_raw_uint32_t nd_uint32_t(const char* _msg){
	...
	for (int i = 4 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_uint32_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
...
sol_raw_int40_t nd_int40_t(const char* _msg){
	...
	for (int i = 5 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_int40_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
...
sol_raw_uint40_t nd_uint40_t(const char* _msg){
	...
	for (int i = 5 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_uint40_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
...
sol_raw_int48_t nd_int48_t(const char* _msg){
	...
	for (int i = 6 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_int48_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
...
sol_raw_uint48_t nd_uint48_t(const char* _msg){
	...
	for (int i = 6 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_uint48_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
...
sol_raw_int56_t nd_int56_t(const char* _msg){
	...
	for (int i = 7 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_int56_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
...
sol_raw_uint56_t nd_uint56_t(const char* _msg){
	...
	for (int i = 7 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_uint56_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
...
sol_raw_int64_t nd_int64_t(const char* _msg){
	...
	for (int i = 8 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_int64_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
...
sol_raw_uint64_t nd_uint64_t(const char* _msg){
	...
	for (int i = 8 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_uint64_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
...
sol_raw_int72_t nd_int72_t(const char* _msg){
	...
	for (int i = 9 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_int72_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
...
sol_raw_uint72_t nd_uint72_t(const char* _msg){
	...
	for (int i = 9 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_uint72_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
...
sol_raw_int80_t nd_int80_t(const char* _msg){
	...
	for (int i = 10 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_int80_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
...
sol_raw_uint80_t nd_uint80_t(const char* _msg){
	...
	for (int i = 10 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_uint80_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
...
sol_raw_int88_t nd_int88_t(const char* _msg){
	...
	for (int i = 11 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_int88_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
...
sol_raw_uint88_t nd_uint88_t(const char* _msg){
	...
	for (int i = 11 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_uint88_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
...
sol_raw_int96_t nd_int96_t(const char* _msg){
	...
	for (int i = 12 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_int96_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
...
sol_raw_uint96_t nd_uint96_t(const char* _msg){
	...
	for (int i = 12 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_uint96_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
...
sol_raw_int104_t nd_int104_t(const char* _msg){
	...
	for (int i = 13 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_int104_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
...
sol_raw_uint104_t nd_uint104_t(const char* _msg){
	...
	for (int i = 13 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_uint104_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
...
sol_raw_int112_t nd_int112_t(const char* _msg){
	...
	for (int i = 14 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_int112_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
...
sol_raw_uint112_t nd_uint112_t(const char* _msg){
	...
	for (int i = 14 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_uint112_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
...
sol_raw_int120_t nd_int120_t(const char* _msg){
	...
	for (int i = 15 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_int120_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
...
sol_raw_uint120_t nd_uint120_t(const char* _msg){
	...
	for (int i = 15 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_uint120_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
...
sol_raw_int128_t nd_int128_t(const char* _msg){
	...
	for (int i = 16 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_int128_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
...
sol_raw_uint128_t nd_uint128_t(const char* _msg){
	...
	for (int i = 16 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_uint128_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
...
sol_raw_int136_t nd_int136_t(const char* _msg){
	...
	for (int i = 17 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_int136_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
...
sol_raw_uint136_t nd_uint136_t(const char* _msg){
	...
	for (int i = 17 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_uint136_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
...
sol_raw_int144_t nd_int144_t(const char* _msg){
	...
	for (int i = 18 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_int144_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
...
sol_raw_uint144_t nd_uint144_t(const char* _msg){
	...
	for (int i = 18 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_uint144_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
...
sol_raw_int152_t nd_int152_t(const char* _msg){
	...
	for (int i = 19 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_int152_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
...
sol_raw_uint152_t nd_uint152_t(const char* _msg){
	...
	for (int i = 19 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_uint152_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
...
sol_raw_int160_t nd_int160_t(const char* _msg){
	...
	for (int i = 20 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_int160_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
...
sol_raw_uint160_t nd_uint160_t(const char* _msg){
	...
	for (int i = 20 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_uint160_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
...
sol_raw_int168_t nd_int168_t(const char* _msg){
	...
	for (int i = 21 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_int168_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
...
sol_raw_uint168_t nd_uint168_t(const char* _msg){
	...
	for (int i = 21 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_uint168_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
...
sol_raw_int176_t nd_int176_t(const char* _msg){
	...
	for (int i = 22 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_int176_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
...
sol_raw_uint176_t nd_uint176_t(const char* _msg){
	...
	for (int i = 22 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_uint176_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
...
sol_raw_int184_t nd_int184_t(const char* _msg){
	...
	for (int i = 23 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_int184_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
...
sol_raw_uint184_t nd_uint184_t(const char* _msg){
	...
	for (int i = 23 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_uint184_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
...
sol_raw_int192_t nd_int192_t(const char* _msg){
	...
	for (int i = 24 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_int192_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
...
sol_raw_uint192_t nd_uint192_t(const char* _msg){
	...
	for (int i = 24 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_uint192_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
...
sol_raw_int200_t nd_int200_t(const char* _msg){
	...
	for (int i = 25 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_int200_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
...
sol_raw_uint200_t nd_uint200_t(const char* _msg){
	...
	for (int i = 25 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_uint200_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
...
sol_raw_int208_t nd_int208_t(const char* _msg){
	...
	for (int i = 26 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_int208_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
...
sol_raw_uint208_t nd_uint208_t(const char* _msg){
	...
	for (int i = 26 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_uint208_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
...
sol_raw_int216_t nd_int216_t(const char* _msg){
	...
	for (int i = 27 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_int216_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
...
sol_raw_uint216_t nd_uint216_t(const char* _msg){
	...
	for (int i = 27 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_uint216_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
...
sol_raw_int224_t nd_int224_t(const char* _msg){
	...
	for (int i = 28 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_int224_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
...
sol_raw_uint224_t nd_uint224_t(const char* _msg){
	...
	for (int i = 28 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_uint224_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
...
sol_raw_int232_t nd_int232_t(const char* _msg){
	...
	for (int i = 29 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_int232_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
...
sol_raw_uint232_t nd_uint232_t(const char* _msg){
	...
	for (int i = 29 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_uint232_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
...
sol_raw_int240_t nd_int240_t(const char* _msg){
	...
	for (int i = 30 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_int240_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
...
sol_raw_uint240_t nd_uint240_t(const char* _msg){
	...
	for (int i = 30 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_uint240_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
...
sol_raw_int248_t nd_int248_t(const char* _msg){
	...
	for (int i = 31 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_int248_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
...
sol_raw_uint248_t nd_uint248_t(const char* _msg){
	...
	for (int i = 31 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_uint248_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
...
sol_raw_int256_t nd_int256_t(const char* _msg){
	...
	for (int i = 32 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_int256_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
...
sol_raw_uint256_t nd_uint256_t(const char* _msg){
	...
	for (int i = 32 ; i > 0; i--){
		retval = retval << 8;
		retval = retval + (sol_raw_uint256_t)(RandData[CounterOfRandData]);
		CounterOfRandData++;
		whether_RunOut();
	}
	whether_RunOut();
